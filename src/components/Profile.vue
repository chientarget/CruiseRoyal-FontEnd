<template>
  <navbar/>
  <section class=" xl:max-w-6xl xl:mx-auto">
    <section class="mb-6 flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <h6 class=" text-3xl ">Profile</h6></div>
      <a class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded-full border-gray-800 dark:border-white ring-gray-300 dark:ring-gray-400 bg-gray-800 text-white dark:bg-white dark:text-black hover:bg-gray-700 hover:dark:bg-slate-100 text-sm px-3 py-1"
         href="#" target="_blank">
        <span class="inline-flex justify-center items-center w-6 h-6 decoration-transparent ">
         <i class="pi pi-cog" style="color: white"></i>
        </span>
        <span class="px-1">Star on GitHub</span></a>
    </section>
        ...
        <div class="justify-around lg:justify-center items-center block md:flex">
          ...
          <div class="flex items-center justify-center">
            <div class="space-y-3 text-center md:text-left lg:mx-12">
              <h1 class="text-2xl"> Xin Chào, <b>Huy Chiến</b>! </h1>
              <p7>Đăng nhập lần cuối <b>12 phút trước</b> từ <b>127.0.0.1</b></p7>
      ...
      <form class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
            ...
            <div class="">
              <div class="flex items-stretch justify-start relative">
                <label class="inline-flex">
                  ...
                  <input type="file" class="absolute top-0 left-0 w-full h-full opacity-0 outline-none cursor-pointer -z-1"></label><!--v-if-->
              </div>
            </div>
          ...
          <div class="mb-6 last:mb-0">
            ...
            <div class="">
              <div class="relative">
                <input name="username" autocomplete="username" type="text" class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800 pl-10">
                ...
                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block"><path fill="currentColor" d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path></svg>
                </span>
              </div>
            </div>
          ...
          <div class="mb-6 last:mb-0">
            ...
            <div class="">
              <div class="relative">
                <input name="email" autocomplete="email" type="email" class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border bg-white dark:bg-slate-800 pl-10">
                <span class="inline-flex justify-center items-center w-10 h-12 absolute top-0 left-0 z-10 pointer-events-none text-gray-500 dark:text-slate-400">
                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block"><path fill="currentColor" d="M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4M17,17H7V15H17M17,13H7V11H17M20,9H17V6H20"></path>
                </svg>
                </span>
              </div>
            </div>
        ...
        <footer class="p-6">
          <div class="flex items-center justify-start flex-wrap -mb-3">
            <button   class="inline-flex justify-center items-center whitespace-nowrap py-2 px-3 mr-3 last:mr-0 mb-3" type="submit"><!--v-if-->
              <span class="px-2">Submit</span>
            </button>
            <button class="inline-flex justify-center items-center whitespace-nowrap py-2 px-3 mr-3 last:mr-0 mb-3" type="button"><!--v-if-->
      ...
      <form class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
        <div class="flex-1 p-6">
          <div class="mb-6 last:mb-0">
            ...
            <div class="">
              <div class="relative">
                <input name="password_current" autocomplete="current-password" type="password" class="px-3 py-2 max-w-full h-12  pl-10 w-full">
                <span class="inline-flex justify-center items-center w-10 h-12 absolute top-0 left-0 z-10  text-gray-500 dark:text-slate-400">
                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block"><path fill="currentColor" d="M21 13H14.4L19.1 17.7L17.7 19.1L13 14.4V21H11V14.3L6.3 19L4.9 17.6L9.4 13H3V11H9.6L4.9 6.3L6.3 4.9L11 9.6V3H13V9.4L17.6 4.8L19 6.3L14.3 11H21V13Z"></path>
                </svg>
              </span>
              </div>
            </div>
            <div class="text-xs text-gray-500 dark:text-slate-400 mt-1">Required. Your current password</div>
          </div>
          ...
          <div class="mb-6 last:mb-0">
            ...
            <div class="">
              <div class="relative">
                <input name="password_confirmation" autocomplete="new-password"  type="password" class="px-3 py-2  h-12   pl-10 w-full">
                <span    class="inline-flex justify-center items-center w-10 h-12 absolute top-0 left-0 z-10 pointer-events-none text-gray-500 dark:text-slate-400">
                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block"><path fill="currentColor" d="M17,7H22V17H17V19A1,1 0 0,0 18,20H20V22H17.5C16.95,22 16,21.55 16,21C16,21.55 15.05,22 14.5,22H12V20H14A1,1 0 0,0 15,19V5A1,1 0 0,0 14,4H12V2H14.5C15.05,2 16,2.45 16,3C16,2.45 16.95,2 17.5,2H20V4H18A1,1 0 0,0 17,5V7M2,7H13V9H4V15H13V17H2V7M20,15V9H17V15H20M8.5,12A1.5,1.5 0 0,0 7,10.5A1.5,1.5 0 0,0 5.5,12A1.5,1.5 0 0,0 7,13.5A1.5,1.5 0 0,0 8.5,12M13,10.89C12.39,10.33 11.44,10.38 10.88,11C10.32,11.6 10.37,12.55 11,13.11C11.55,13.63 12.43,13.63 13,13.11V10.89Z"></path></svg></span>
              </div>
            </div>
            <div class="text-xs text-gray-500 dark:text-slate-400 mt-1">Required. New password one more time</div>
          </div>
        </div>
        <footer class="p-6">
          <div class="flex items-center justify-start flex-wrap -mb-3">
            <button  class="inline-flex justify-center items-center whitespace-nowrap  py-2 px-3 mr-3 last:mr-0 mb-3"
                type="submit"><!--v-if-->
              <span class="px-2">Submit</span></button>
            <button  class="inline-flex justify-center items-center whitespace-nowrap  py-2 px-3 mr-3 last:mr-0 mb-3"
                type="button"><!--v-if-->
              <span class="px-2">Options</span></button>
          </div>
        </footer>
      </form>
    </div>
  ...
  <div class="ForgotPassword-container justify-around lg:justify-center items-center block md:flex ">

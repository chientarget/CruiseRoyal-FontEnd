<template>
  <div class="flex justify-center mt-48 relative rounded-3xl">
    <div class=" min-h-screen w-full max-w-screen-xl">
      <div class="head">
        <h1 class="text-3xl font-bold mb-6">Du thuyền mới và phổ biến nhất</h1>
        <p class="mb-8 text-gray-600"> Tận hưởng sự xa hoa và đẳng cấp tối đa trên du thuyền mới nhất và phổ biến nhất... </p>
      </div>


      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 ">
        <div v-for="cruise in cruises" :key="cruise.id" class="">
          <Card class="w-11/12  h-30rem overflow-hidden rounded-3xl mb-4 ">
            <template #header>
              <div class="relative">
                <img :alt="cruise.name" :src="cruise.image" class="w-full h-60  object-cover p-3 rounded-4xl"/>
                <div class="absolute top-7 left-7 bg-yellow-300 text-orange-900 px-2 py-1 rounded-3xl text-sm flex items-center gap-1">
            ...
            <template #title>
              <div class="h-0.5rem">
              <p class="text-sm"><span class="pi pi-flag"></span>  Vịnh Hạ Long</p>
              </div>
              {{ cruise.name }}
            </template>
            ...
            <template #footer>
              <div class="flex gap-3 mt-1 ">
                <p class="text-gray-900 font-bold">{{ cruise.price }} / khách</p>
                <Button label="Đặt ngay" class=" "/>
              </div>
            </template>
          </Card>
        </div>
      ...
      cruises: [
        {
          ...
          description: 'Vịnh Hạ Long - Hạ thủy 2019 - Tàu vỏ Kim loại - 20 phòng',
          price: '3,550,000đ',
        },
        {
          id: 2,
          ...
          description: 'Vịnh Hạ Long - Hạ thủy 2018 - Tàu vỏ Kim loại - 22 phòng',
          price: '5,300,000đ',
        },
        {
          id: 3,
        ...
        },
        {
          ...
          id: 5,
          image: 'Cruises/Cruise05.webp',
          name: 'Du Thuyền Stellar of the Seas',
          description: 'Vịnh Hạ Long - Hạ thủy 2018 - Tàu vỏ Kim loại - 22 phòng',
          price: '5,300,000đ',
        }, {
          id: 6,
          image: 'Cruises/Cruise06.webp',
          name: 'Du Thuyền Stellar of the Seas',
          description: 'Vịnh Hạ Long - Hạ thủy 2018 - Tàu vỏ Kim loại - 22 phòng',
          price: '5,300,000đ',
        },

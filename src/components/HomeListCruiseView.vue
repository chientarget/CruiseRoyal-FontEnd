<template>
  <div class="flex justify-center mt-48 relative">
    <div class="min-h-screen w-full max-w-screen-xl">
      ...
      <div class="grid grid-cols-3 ">
        <Card class="max-w-md rounded-3xl shadow-1 m-3 p-3" v-for="cruise in cruises" :key="cruise.id">
          <template #header>
            <div class="relative">
              ...
              <div class="flex gap-1 h-5 bg-gray-100 rounded-full px-2 py-1 align-items-center absolute bottom--7 left-3  ">
          ...
          <template #content>
            <p class="text-sm text-gray-800  align-items-center ">
  ...
  <div class="flex justify-center mt-10 relative">
    <Button class=" align-items-center rounded-full p-3 bg-transparent border-none text-black shadow-2" icon="pi pi-chevron-right" label="Xem tất cả Du thuyền" iconPos="right" />

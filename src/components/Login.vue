...
>>>>>>> 5193c86c1f95c19c85b7b740482a3935a919c4ef
...
=======
      ...
      <div class="link-container flex align-items-center">
        <Button label="Đăng nhập" severity="primary" class="login-button  rounded-pill w-100 mt-3" @click="login" />
      </div>
      ...
      <div class="welcome-message text-end mb-3 pt-2">
        <a @click="handleForgotPassword"
          class="font-medium no-underline ml-2 pr-2 text-right cursor-pointer text-purple-800">Chưa có tài khoản ? Đăng
          ký</a>
      </div>
